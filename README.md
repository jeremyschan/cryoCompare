...
Generative AI was used only for proofreading, minor code optimisation
...
added unit tests, example data, documentation (roxygen/manual pages and
README), and package metadata (DESCRIPTION/NAMESPACE) to make the
project easy to install and reproduce.
